    ...
    class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
            ...
            if ( $this->has_children && 0 === $depth ) {
                $atts['href']          = $item->url === '#weglot_switcher' ? '#weglot_switcher' : '#';
                $atts['data-toggle']   = 'dropdown';
                $atts['aria-haspopup'] = 'true';
                $atts['aria-expanded'] = 'false';
                $atts['class']         = 'dropdown-toggle nav-link';
                $atts['id']            = uniqid() . '-menu-item-dropdown-' . $item->ID; // Add uniq ID for Accessibilty (duplicate menu)
            } else {
 ...
 * @return array
 */
function webexpr_bs5_dropdown_data_attribute( $atts, $item, $args ) {
...
add_filter( 'nav_menu_link_attributes', 'webexpr_bs5_dropdown_data_attribute', 20, 3 );
